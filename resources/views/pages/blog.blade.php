...
<head>
    ...
    <title>{{ $settings->salon_name ?? 'service business' }} - Blog</title>
...
<body class="antialiased bg-gray-50">
            ...
            <div class="flex justify-between h-20">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center space-x-3">
                        ...
                        <span class="text-2xl font-bold gradient-text">{{ $settings->salon_name ?? 'service business' }}</span>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Beauty tips, trends, and expert advice from our team
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            @if($posts->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($posts as $post)
                        <article class="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all border border-gray-100">
                            ...
                            <div class="p-6">
                                @if($post->category)
                                    <span class="inline-block bg-pink-100 text-pink-700 px-3 py-1 rounded-full text-xs font-semibold mb-3">
                                        {{ $post->category }}
                                    </span>
                                @endif
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                    ...
                                    <a href="{{ route('blog.post', $post->slug) }}" class="inline-flex items-center text-pink-600 hover:text-pink-700 font-semibold text-sm group">
                                        Read More
            ...
            @else
                <div class="text-center py-20">
                    ...
                    <p class="text-gray-500">Check back soon for beauty tips and expert advice!</p>
                </div>
            @endif
        </div>
    </section>
    ...
    <section class="py-20 bg-gradient-to-r from-pink-600 to-purple-600 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-4xl md:text-5xl font-extrabold mb-6">Ready for Your Next Beauty Treatment?</h2>
            <p class="text-xl mb-10 opacity-90">Book your appointment and experience our professional services</p>
    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">{{ $settings->salon_name ?? 'service business' }}</h3>
