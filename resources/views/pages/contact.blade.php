...
<head>
    ...
    <title>{{ $settings->salon_name ?? 'service business' }} - Contact Us</title>
    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50">
            ...
            <div class="flex justify-between h-16 lg:h-20">
                <div class="flex items-center">
                    ...
                    <div class="hidden lg:ml-10 lg:flex lg:space-x-8">
                        ...
                        <a href="{{ route('contact') }}" class="text-gray-900 hover:text-pink-600 px-3 py-2 text-sm font-medium border-b-2 border-pink-600">Contact</a>
                    </div>
                </div>
        ...
        <div id="mobile-menu" class="hidden lg:hidden bg-white border-t">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="{{ route('contact') }}" class="block px-3 py-2 text-base font-medium text-pink-600 bg-pink-50 rounded-md">Contact</a>
            </div>
        </div>
    </nav>
