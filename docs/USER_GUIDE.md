...
5. [Viewing Your History](#viewing-your-history)
...
10. [Managing Clients](#managing-clients)
11. [Scheduling Appointments](#scheduling-appointments)
12. [Processing Payments](#processing-payments)
...
18. [Business Reports](#business-reports)
...
2. Navigate to your salon's website
3. Click "Book Appointment" or "Client Portal"
...
3. Click on your desired service
4. Review service details, duration, and price

#### Step 2: Choose Staff Member
1. Select your preferred staff member
2. View staff profiles and specialties
3. Choose "Any Available" if you have no preference

#### Step 3: Select Date and Time
1. Choose your preferred date
2. View available time slots
3. Select a time that works for you
4. Green slots = Available
5. Red slots = Unavailable

#### Step 4: Add Special Requests
1. Add any special requests or notes
2. Mention allergies or sensitivities
3. Request specific products or techniques
...
- Book recurring appointments for convenience
...
4. See appointment status and details

### Rescheduling Appointments
1. Find your appointment in "My Appointments"
2. Click "Reschedule"
3. Choose a new date and time
4. Confirm the changes
5. You'll receive an updated confirmation
...
5. Check the cancellation policy for any fees

### Appointment Reminders
- Email reminders sent 24 hours before
- SMS reminders sent 2 hours before
...
3. See service details and staff members
4. Track your service preferences

### Payment History
1. Go to "Payment History"
2. View all past payments
3. Download receipts
4. Track loyalty points earned

### Communication History
1. Go to "Messages"
2. View all communications with the salon
3. See appointment confirmations
4. Read promotional messages
...
### Preferences
1. Set your preferred services
2. Choose your favorite staff members
...
4. Control marketing communications
...
- Contact salon for refund requests
- Check refund policy for details
...
2. View your point balance
3. Browse available rewards
4. Redeem points for services or products
...
4. Check client notes and preferences
...
### Client Information
1. Access client profiles
2. View service history
3. Read client notes
4. Update client preferences
...
### Client Profiles
1. Search for clients by name or phone
2. View complete client information
3. Update client details
4. Add service notes

### Service History
1. View client's past services
2. See service preferences
...
5. Print receipt
6. Update client account

### Refunds and Adjustments
1. Select the original payment
2. Choose refund or adjustment
3. Enter amount and reason
4. Process the refund
5. Update client account
...
### Product Usage
1. Record products used during services
2. Update inventory levels
3. Track product costs
4. Monitor waste and spoilage
...
4. Contact salon for assistance
...
- Provide feedback after services
- Keep payment information current

### For Staff
- Update client notes after each service
